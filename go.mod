...
require (
	...
	github.com/waku-org/sds-go-bindings v0.0.0-20260129095305-d2e2c8252a23
...
replace github.com/waku-org/sds-go-bindings => github.com/jrainville/sds-go-bindings v0.0.0-20260319161334-7d2a4facaed3
